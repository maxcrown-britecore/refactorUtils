from codebase_services.core import (
...
class CodeExtractorService:
    ...
    def _merge_imports(
        ...
        # Simple strategy: keep existing imports and add new ones
        ...
        if new_imports.strip():
            result_lines.extend(['', '# Additional imports'])
            result_lines.extend(new_imports.split('\n'))
